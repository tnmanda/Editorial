...
namespace LNWCOE.Service.Controllers.Admin.Misc
{
    ...
    public class ApplicationModulesController : ControllerBase<ApplicationModulesController>
    {
        private readonly IApplicationModulesRepository _repository;

        public ApplicationModulesController(IApplicationModulesRepository repository)
        {
