...
namespace LNWCOE.Service.Controllers.Admin
{
    ...
    public class WorkUnitTypeController : ControllerBase<WorkUnitTypeController>
    {
        private readonly IWorkUnitTypeRepository _repository;

        public WorkUnitTypeController(IWorkUnitTypeRepository repository)
        {
