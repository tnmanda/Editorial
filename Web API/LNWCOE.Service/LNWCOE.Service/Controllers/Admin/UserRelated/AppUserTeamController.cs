...
namespace LNWCOE.Service.Controllers.Admin
{
    ...
    public class AppUserTeamController : ControllerBase<AppUserTeamController>
    {
        private readonly IAppUserTeamRepository _repository;

        public AppUserTeamController(IAppUserTeamRepository repository)
        {
        ...
        [HttpPost]
        public IActionResult Create([FromBody] AppUserTeam newentry)
        {
        ...
        [HttpPut]
        public IActionResult Update([FromBody] AppUserTeam editentry)
        {
            var result = _repository.Update(editentry, editentry.AppUserTeamID);
            return Helper.CheckResult(result);
        }
