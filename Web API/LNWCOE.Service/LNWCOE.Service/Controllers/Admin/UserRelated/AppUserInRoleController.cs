...
namespace LNWCOE.Service.Controllers.Admin
{
    ...
    public class AppUserInRoleController : ControllerBase<AppUserInRoleController>
    {
        private readonly IAppUserInRoleRepository _repository;

        public AppUserInRoleController(IAppUserInRoleRepository repository)
        {
        ...
        [HttpPost]
        public IActionResult Create([FromBody] AppUserInRole newentry)
        {
        ...
        [HttpPut]
        public IActionResult Update([FromBody] AppUserInRole editentry)
        {
            var result = _repository.Update(editentry, editentry.AppUserInRoleID);
            return Helper.CheckResult(result);
        }
