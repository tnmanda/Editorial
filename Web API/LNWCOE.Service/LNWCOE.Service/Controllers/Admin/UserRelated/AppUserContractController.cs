...
namespace LNWCOE.Service.Controllers.Admin
{
    ...
    public class AppUserContractController : ControllerBase<AppUserContractController>
    {
        private readonly IAppUserContractRepository _repository;

        public AppUserContractController(IAppUserContractRepository repository)
        {
