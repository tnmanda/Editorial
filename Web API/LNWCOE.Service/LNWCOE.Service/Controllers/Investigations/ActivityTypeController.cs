...
namespace LNWCOE.Service.Controllers.Investigations
{
    ...
    public class ActivityTypeController : ControllerBase<ActivityTypeController>
    {
        ...
        [HttpPost]
        public IActionResult Create([FromBody] ActivityType newentry)
        {
        ...
        [HttpPut]
        public IActionResult Update([FromBody] ActivityType editentry)
        {
            var result = _repository.Update(editentry, editentry.ActivityTypeID);
            return Helper.CheckResult(result);
        }
