...
namespace LNWCOE.Service.Controllers.Investigations
{
    ...
    public class InvestigationNoteController : ControllerBase<InvestigationNoteController>
    {
        private readonly IInvestigationNoteRepository _repository;

        public InvestigationNoteController(IInvestigationNoteRepository repository)
        {
        ...
        [HttpPost]
        public IActionResult Create([FromBody] InvestigationNote newentry)
        {
        ...
        [HttpPut]
        public IActionResult Update([FromBody] InvestigationNote editentry)
        {
            var result = _repository.Update(editentry, editentry.InvestigationNoteID);
            return Helper.CheckResult(result);
        }
