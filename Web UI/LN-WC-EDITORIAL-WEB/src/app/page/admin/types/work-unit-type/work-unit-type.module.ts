...
import { WorkUnitTypeRoutingModule } from './work-unit-type-routing.module';
...
@NgModule({
  ...
  declarations: [
    WorkUnitTypeListComponent,
    WorkUnitTypeDeleteDialogComponent,
    WorkUnitTypeAddDialogComponent,
    WorkUnitTypeEditDialogComponent,
  ]
})
export class WorkUnitTypeModule { }
