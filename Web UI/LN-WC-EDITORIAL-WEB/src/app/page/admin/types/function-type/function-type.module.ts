...
import { FunctionTypeRoutingModule } from './function-type-routing.module';
...
@NgModule({
  ...
  declarations: [
    FunctionTypeListComponent,
    FunctionTypeAddDialogComponent,
    FunctionTypeEditDialogComponent,
    FunctionTypeDeleteDialogComponent,
  ]
})
export class FunctionTypeModule { }
