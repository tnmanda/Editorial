...
import { UsermapAddDialogComponent } from './usermap-add-dialog.component';
...
describe('UsermapAddDialogComponent', () => {
  let component: UsermapAddDialogComponent;
  let fixture: ComponentFixture<UsermapAddDialogComponent>;
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      ...
      declarations: [ UsermapAddDialogComponent ],
      providers: [
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(UsermapAddDialogComponent);
