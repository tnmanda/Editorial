...
import { JobControlAddDialogComponent } from './job-control-add-dialog.component';
...
describe('JobControlAddDialogComponent', () => {
  let component: JobControlAddDialogComponent;
  let fixture: ComponentFixture<JobControlAddDialogComponent>;
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      ...
      declarations: [ JobControlAddDialogComponent ],
      providers: [
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(JobControlAddDialogComponent);
