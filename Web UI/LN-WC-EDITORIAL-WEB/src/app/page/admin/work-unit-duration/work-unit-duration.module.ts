...
import { WorkUnitDurationRoutingModule } from './work-unit-duration-routing.module';
...
@NgModule({
  ...
  declarations: [
    WorkUnitDurationListComponent,
    WorkUnitDurationAddDialogComponent,
    WorkUnitDurationEditDialogComponent,
    WorkUnitDurationDeleteDialogComponent,
  ]
})
export class WorkUnitDurationModule { }
