...
import { OfficeEditDialogComponent } from './office-edit-dialog.component';
...
describe('OfficeEditDialogComponent', () => {
  let component: OfficeEditDialogComponent;
  let fixture: ComponentFixture<OfficeEditDialogComponent>;
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      ...
      declarations: [ OfficeEditDialogComponent ],
      providers: [
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(OfficeEditDialogComponent);
